    ...
    <main className="min-h-screen bg-[#030303] flex overflow-hidden">
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-16 relative">
        ...
        <div>
          ...
          <h1 className="text-4xl font-black text-white mb-4">Join 413 OPENCOURT</h1>
          <p className="text-gray-400 text-lg max-w-md leading-relaxed">
            Start your basketball journey. Get access to training videos,
            book coaching sessions, and track your progress.
          </p>
        </div>
        ...
        <div className="space-y-6">
          {[
            ...
            { icon: "🎯", title: "Personalized training", desc: "Drills tailored to your level" },
            { icon: "💬", title: "Direct coach access", desc: "Chat with your coach anytime" },
          ].map((item, i) => (
            <motion.div
              key={i}
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-gray-400 mb-8">Start your basketball training journey</p>
