    ...
    <main className="min-h-screen bg-[#030303] text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-3 md:px-8 py-4 md:py-5">
          <div className="flex items-center gap-2 md:gap-3 min-w-0">
            ...
            <button
              ...
              className="md:hidden flex items-center gap-1.5 h-11 px-3 bg-white text-black rounded-full font-bold text-sm active:scale-95 transition-transform shadow-lg shadow-black/40 select-none shrink-0"
            >
              <span className="relative w-3.5 h-3 flex flex-col justify-center gap-[3.5px]">
                <span className={`block w-3.5 h-[3px] bg-black rounded-full transition-all duration-300 ${mobileOpen ? "rotate-45 translate-y-[5px]" : ""}`} />
                <span className={`block w-3.5 h-[3px] bg-black rounded-full transition-all duration-300 ${mobileOpen ? "opacity-0" : ""}`} />
                <span className={`block w-3.5 h-[3px] bg-black rounded-full transition-all duration-300 ${mobileOpen ? "-rotate-45 -translate-y-[5px]" : ""}`} />
              </span>
      ...
      <section className="relative pt-40 pb-20 px-8 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-20">
          ...
          >
            Be the go-to basketball development program for kids and adults
            starting from zero.
          </motion.p>
